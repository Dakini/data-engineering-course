...
with green_tripdata as (
    select *, 
        ...
        'Green' as trip_source  -- New column to track dataset source
    from {{ ref('stg_green_tripdata') }}
), 
yellow_tripdata as (
    select *, 
        'Yellow' as service_type, 
        'Yellow' as trip_source  -- New column to track dataset source
...
select 
    ...
    trips_unioned.trip_source,  -- New column indicating dataset source
